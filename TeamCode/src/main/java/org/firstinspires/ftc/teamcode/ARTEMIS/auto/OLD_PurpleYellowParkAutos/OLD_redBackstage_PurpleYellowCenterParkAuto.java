...
import static org.firstinspires.ftc.teamcode.ARTEMIS.auto.OLD_PurpleYellowParkAutos.OLD_Artemis_PurpleYellowParkAutoTrajectories.OLD_redBackstage_WaypointToCenterPark;
...
@Disabled
@Autonomous(group = "drive", name = "redBackstage Purple+Yellow+CenterPark")
public class OLD_redBackstage_PurpleYellowCenterParkAuto extends CommandOpMode {
        ...
        schedule(new SequentialCommandGroup(
                ...
                new ParallelDeadlineGroup(
                        new SequentialCommandGroup(
                                ...
                                new FollowTrajectoryCommand(drive, OLD_redBackstage_WaypointToCenterPark)
                        ),
                        new SequentialCommandGroup(
                                new WaitCommand(500),
