...
@Disabled
@Autonomous(group = "drive", name = "OLD blueWings FARBACK Purple+Yellow+CornerPark")
public class OLD_blueWings_FARBACK_PurpleYellowCornerParkAuto extends CommandOpMode {
