...
public class YellowBoxDetectionPipeline extends OpenCvPipeline {
    ...
    public YellowBoxDetectionPipeline() {
    ...
    public Mat processFrame(Mat input) {
        ...
        //hue for blue (80 to 160)
        //hue for orange (0 to 30)
        //purple (hue 120-170, value 80-200)

//        Scalar lowHSV = new Scalar(120, 70, 80); // lenient lower bound HSV for blue
//        Scalar highHSV = new Scalar(170, 255, 200); // lenient higher bound HSV for blue
        ...
        Scalar strictLowHSV = new Scalar(0, strictLowS, 0); //strict lower bound HSV
        Scalar strictHighHSV = new Scalar(255, strictHighS, 255); //strict higher bound HSV
       ...
       // scaledThresh.copyTo(input);
        ...
        scaledMask.release(); //darker version of HSV vision
        mat.release(); //this one shows everything in blue-green
        masked.release(); //HSV vision
//        edges.release(); //just the outline
        thresh.release(); //black and white but more blobby
        finalMask.release(); //HSV, more limited
