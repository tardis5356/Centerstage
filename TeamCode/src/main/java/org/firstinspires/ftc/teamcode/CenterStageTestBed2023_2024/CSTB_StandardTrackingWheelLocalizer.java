...
public class CSTB_StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public CSTB_StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "mBL"));
