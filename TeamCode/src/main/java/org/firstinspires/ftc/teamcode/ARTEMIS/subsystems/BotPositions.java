...
public class BotPositions {
    ...
    //wrist positions
    public static double WRIST_LEFT_ROLL = 0.497, WRIST_RIGHT_ROLL = 0.432, WRIST_ROLL_CENTERED = 0.464, WRIST_TILT_TRANSITION = 0.79, WRIST_TILT_INTAKE = 0.768, WRIST_TILT_DEPOSIT = 0.69, WRIST_TILT_DROP_PURPLE = 0.67;
    //for tilt, 0.09 = 30º
//    0.115 = 30º
