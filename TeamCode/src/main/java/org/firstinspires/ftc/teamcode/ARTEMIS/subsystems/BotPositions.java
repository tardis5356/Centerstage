...
public class BotPositions {
    ...
    //wrist positions
    public static double WRIST_LEFT_ROLL = 0.497, WRIST_RIGHT_ROLL = 0.432, WRIST_ROLL_CENTERED = 0.465, WRIST_TILT_TRANSITION = 0.79, WRIST_TILT_INTAKE = 0.768, WRIST_TILT_DEPOSIT = 0.69;
    //for tilt, 0.09 = 30º
//    0.115 = 30º

    //arm positions
    public static double ARM_INTAKE = 0.04, ARM_TRANSITION_POSITION = 0.12,  ARM_DEPOSIT = 0.79, ARM_GRAB_PIXELS = .01;
