...
//    public static double LEFT_BRACE_EXTENDED = 0.69, RIGHT_BRACE_EXTENDED = 0.68, RIGHT_BRACE_RETRACTED = 0.92, LEFT_BRACE_OVEREXTENDED = 0.28, RIGHT_BRACE_OVEREXTENDED = 0.35;
    public static  double BAR_LATCHED = 0.713, BAR_UNLATCHED = 0.5, HOOK_LATCHED = 0.74, HOOK_STAGE2_UNLATCHED = 0.6, HOOK_STAGE1_UNLATCHED = 0.65;
...
//    0.115 = 30º
    ...
    public static double BACK_WEBCAM_Y_OFFSET = 0, BACK_WEBCAM_X_OFFSET = 8, FRONT_WEBCAM_X_OFFSET = -8; // x is front to back, y is side to side
    // 7.5
}
