...
public class BotPositions {
    ...
    //brace positions
    public static double LEFT_BRACE_EXTENDED = 0.69, RIGHT_BRACE_EXTENDED = 0.68, LEFT_BRACE_OVEREXTENDED = 0.28, RIGHT_BRACE_OVEREXTENDED = 0.35;
...
//    0.115 = 30º
    ...
    //arm positions
    public static double ARM_INTAKE = 0.025, ARM_TRANSITION_POSITION = 0.12,  ARM_DEPOSIT = 0.65, ARM_DROP_PURPLE = 0.9, ARM_GRAB_PIXELS = .025;
